    ...
    const scrapedData = await page.evaluate(() => {
      ...
      function extractElementData(element, depth = 0) {
        ...
        if (computed.boxShadow && computed.boxShadow !== 'none') {
          // Basic shadow parsing (simplified)
          elementData.effects = [{
            type: 'DROP_SHADOW',
      ...
      const enhancedData = {
        version: '2.0.0', // Updated version to indicate enhanced data
        metadata: {
        ...
        assets: {},
        styles: {
          colors: [], // Will be populated with used colors
          textStyles: [], // Will be populated with text styles
          effects: []
        },
        components: {},
        variants: {}
